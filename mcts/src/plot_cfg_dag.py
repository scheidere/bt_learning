...
def plot_cfg_dag(list_of_all_nodes, winner, use_uct, max_height, exploration_exploitation_parameter, print_text, filename):
        ...
        if n.parents:
            ...
            if node_height == max_height and len(n.children) > 0:
                ...
                if print_text:
                    ...
                    node_text = ""
                u.node(node_id_cont, node_text, shape="plaintext")
