...
def run():
    ...
    # Create output file
    f = open("/home/graeme/Dropbox/emily_graeme_shared/results_from_graeme/simple/all_methods_output/" + str(start_time_milli) + current_method + "_output.txt","w+") #overall output file, can't load while running
