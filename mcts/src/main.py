...
def run():
    ...
    # Create output file
    f = open("/home/scheidee/Desktop/bt_learning_output/all_methods_output/2020_10_18/" + str(start_time_milli) + current_method + "_output.txt","w+") #overall output file, can't load while running
